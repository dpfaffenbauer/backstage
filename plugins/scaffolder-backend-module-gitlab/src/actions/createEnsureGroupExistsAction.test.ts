...
import { createEnsureGroupExistsAction } from './createEnsureGroupExistsAction';
...
describe('gitlab:ensure-group-exists', () => {
  const mockContext = {
    workspacePath: 'lol',
  ...
  it('should create a new group if it does not exists', async () => {
    ...
    const action = createEnsureGroupExistsAction({ integrations });
